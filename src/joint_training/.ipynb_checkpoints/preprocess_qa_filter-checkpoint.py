...
for data_name in data_list:
    ...
    rule_dataset = utils.load_jsonl('/workspace/longxiao/KGQA/RoG/reasoning-on-graphs-master/results/gen_rule_path/cwq/RoG_cwq/train/predictions_6_False.jsonl')
