...
# save_dir = "/workspace/longxiao/KGQA/RoG/reasoning-on-graphs-master/datasets/AlignData/processed"
save_dir = "/workspace/longxiao/KGQA/RoG/reasoning-on-graphs-master/datasets/joint_training/align"
prompt_path = "/workspace/longxiao/KGQA/RoG/reasoning-on-graphs-master/prompts/llama2.txt" 
# data_template = "/workspace/longxiao/KGQA/RoG/reasoning-on-graphs-master/src/align_kg/datasets/AlignData/{}/{}_train.jsonl"
data_template = "/workspace/longxiao/KGQA/RoG/reasoning-on-graphs-master/datasets/AlignData/{}/{}_train_3hops_filter.jsonl"
data_list = ['cwq'] # 'webqsp' 'cwq'
...
for data_name in data_list:
    ...
    save_path = os.path.join(save_dir, data_name, data_name + "_train_3hops_filter.jsonl")
