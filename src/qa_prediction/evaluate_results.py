...
def eval_result(predict_file, cal_f1=True, topk = -1):
    ...
    eval_name = "detailed_eval_result_top_{topk}.jsonl" if topk > 0 else 'my_detailed_eval_result.jsonl'
    ...
    print(result_str)
    result_name = "eval_result_top_{topk}.txt" if topk > 0 else 'my_eval_result.txt'
...
if __name__ == "__main__":
    ...
    argparser.add_argument('-d', type=str, default='xxxxx') # 
    argparser.add_argument('--cal_f1', action="store_true", default=True)
